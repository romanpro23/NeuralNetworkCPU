...
import neural_network.optimizers.RMSPropOptimizer;
...
public class TestAlexNet {
    public static void main(String[] args) throws Exception {
       Optimizer optimizer = new RMSPropOptimizer();
...
//                .create();
        ...
        NeuralNetwork alexnet = NeuralNetwork
                .read(new Scanner(new File("D:/NetworkTest/ciraf/_alexnet.txt")))
                .setFunctionLoss(new FunctionLoss.CategoricalCrossEntropy())
                .setOptimizer(optimizer)
//                .setStopGradient(13)
                .create();
//
        optimizer.read(new Scanner(new File("D:/NetworkTest/ciraf/_alexnet_optimizer.txt")));
//        optimizerConv.read(new Scanner(new File("D:/NetworkTest/ciraf/alexnet_optimizer_conv.txt")));
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            optimizer.save(new FileWriter("D:/NetworkTest/ciraf/_alexnet_optimizer.txt"));
//            optimizerConv.save(new FileWriter("D:/NetworkTest/ciraf/alexnet_optimizer_conv.txt"));
            trainer.train(alexnet, 64, 1, new DataMetric.Top1());
            if (i % 2 == 0) {
